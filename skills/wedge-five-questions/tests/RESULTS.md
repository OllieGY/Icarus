...
|---|---|---|---|---|---|---|---|
| 01 Larder Labs (stockout digest) | 5 | 5 | 5 | 5 | 5 | 25 | PASS — 5/5 REAL WEDGE; rejects the 0.3 "they said they'd like it" Q4, upgrades to observed 40 min/wk ERP retyping; names already-collected number (exports/account/Monday). |
| 02 Meridian Grid (month-end risk digest) | 5 | 5 | 5 | 5 | 5 | 25 | PASS — 5/5 with caveat; counts only the 1 operator's observed 2 non-users, explicitly refuses the assumed 2nd forward (0.1), flags n=1 travel to reconfirm. |
| 03 Foundry Signal (shift copilot) | 5 | 5 | 5 | 5 | 5 | 25 | PASS (refusal case) — Q3 travel = 0 non-users → 4/5 → NOT A WEDGE; refuses "managers could share it" (0.1); names the flip (native shift-handover note to supervisors' channel). Kill line honored. |
| 04 Halcyon Safety (gas-safety digest) | 5 | 5 | 5 | 4 | 5 | 24 | PASS — 5/5; regulated shift-handover = gold-standard Q2; crew (6–10) + regulator clear Q3; flags 2-rig sample. Challenge lighter (clean pass, little to push on). |
