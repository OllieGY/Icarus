...
> _One testable question about one unknown. Not "test the idea." If you have
> several, rank by probability-wrong × cost-if-wrong and take the top one._

**The question:** _______________
...
Tick the row the question is really asking about.

| ☐ | Target | Asking about… | Rung the answer needs |
|---|---|---|---|
| ☐ | A — Legibility | is the workflow legible; where the decision sits | comprehension (0.5) |
| ☐ | B — Pull | would they use it if it worked | behaviour toward the promise (0.7) |
| ☐ | C — Pay & workflow | will they pay; the real workflow incl. exceptions | money (1.0) + behaviour (0.7) |
| ☐ | D — Automation & cost | can an agent do it; cost per outcome | cost money-grade (1.0) + frontier (0.7) |
...
_(name the rung it produces vs the rung the question needs)_

**What it will STILL lie about (mandatory — name it):** _______________

**Cost + timebox:** _______________

## Step 5 — Pre-registered pass/fail read-out

Set before running. Behaviour or money only — a verbal or opinion read-out is not
a valid read-out.

| | |
|---|---|
| **Metric (behaviour / money):** | _______________ |
| **Pass threshold:** | _______________ |
| **Fail threshold:** | _______________ |
| **Sample / timebox:** | _______________ |
| **A pass moves the claim to rung:** | _______________ `[tag]` |
